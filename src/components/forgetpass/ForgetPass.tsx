      ...
      {!codeVerified ? (
        <>
          <div className="w-11/12 sm:w-8/12 lg:w-6/12 xl:w-4/12 bg-gray-100 rounded-2xl shadow-lg pt-8 mx-auto mt-20 md:mt-40">
            <h3 className="text-center text-xl text-purple-800">
              فراموشی رمزعبور
            </h3>
            <div className="p-8 sm:p-16" dir="rtl">
              <Input
                ...
                type="email"
              />
              <p className="text-red-600 text-xs mb-8 px-4">
              ...
              {emailExist && (
                <div className="mb-6 mx-auto" dir="rtl">
                  ...
                  <InputOTP
                    ...
                    onChange={(value) =>
                      dispatch(RsetForgetVerficationCode(value))
                    }
                  ...
                  <a
                    ...
                    className={
                      time === 0
                        ? "text-xs mb-8 px-2 hover:text-purple-600 cursor-pointer"
                        : "text-xs mb-8 px-2"
                    }
                  >
                    {time === 0
                      ? `دریافت مجدد ایمیل`
                      : ` ایمیلی دریافت نکردید؟ دریافت مجدد پس از ${formatTime(
                          time
                        )}`}
                  </a>
                </div>
